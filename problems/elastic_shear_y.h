...
class ElasticShearY: public ProblemBase
{
private:
   /*********************************************************
   ...
   string _indicator = "ElasticShearY";
...
public:
   ElasticShearY(const int &_dim) : ProblemBase(_dim)
   {
      if (dim != 2)
      {
         /*
