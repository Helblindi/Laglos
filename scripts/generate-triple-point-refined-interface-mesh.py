...
def main():
   ...
   ny_gridpoints2 = 4
   ny_gridpoints3 = 6
   ny_gridpoints = ny_gridpoints1 + ny_gridpoints2 + ny_gridpoints3
   xL = 0.
   xR = 7.
   yL = 0.
   y1 = 1.25
   ...
   y_arr1 = np.linspace(yL,y1, ny_gridpoints1, endpoint=False)
   y_arr2 = np.linspace(y1,y2, ny_gridpoints2, endpoint=False)
   y_arr3 = np.linspace(y2, yR, ny_gridpoints3)
   # y_arr = np.linspace(yL,yR,ny_gridpoints)
   y_arr = np.concatenate((y_arr1, y_arr2, y_arr3))
   print("y_arr: ", y_arr)
